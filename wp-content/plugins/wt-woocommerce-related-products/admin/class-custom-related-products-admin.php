    ...
    function crp_select_related_products() {
        ...
        <div class="wt_crp_options_group">
            ...
            <p class="form-field"><label for="related_product_tag"><?php _e('Related tags', 'wt-woocommerce-related-products'); ?></label>
                <select id="crp_related_product_tags" name="crp_related_product_tags[]"  class="wc-taxonomy-term-search" data-taxonomy="product_tag" data-return_id="id" multiple="multiple" data-placeholder="<?php esc_attr_e('No tags', 'wt-woocommerce-related-products'); ?>" style="width: 400px;">
                    <?php
